    ...
    return (
      <div className='container'>
        <BootstrapTable
          ...
          <TableHeaderColumn dataField='city' dataSort={true} dataAlign='center' filter={{
            type: 'TextFilter',
            placeholder: 'Keress városra',
            delay: 500
          }}>City</TableHeaderColumn>
          <TableHeaderColumn dataField='pop' dataSort={true} filter={{
            type: 'NumberFilter',
            placeholder: 'Keress',
            delay: 500,
            numberComparators: ['=', '>', '<=']
          }}>Population</TableHeaderColumn>
          <TableHeaderColumn dataField='state' dataSort={true} filter={{
            type: 'RegexFilter',
            placeholder: 'Keress államra',
            delay: 500
          }}>State</TableHeaderColumn>
          <TableHeaderColumn dataField='pop' dataFormat={this.customLabel} dataSort={true}>City
...
PlaceholderDataTable.propTypes = {
  usaZip: PropTypes.array,
};
