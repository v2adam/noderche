      ...
      <nav className='navbar navbar-default'>
        <div className='container-fluid'>
          ...
          <ul className='nav navbar-nav'>
            ...
            {secretMenu}
            <li><NavLink activeClassName='active' to='/dashboard_editor'>Dashboard Editor</NavLink>
            </li>
            <li><NavLink activeClassName='active' to='/dashboard'>Dashboard View</NavLink></li>
          </ul>
        </div>
      </nav>
    );
